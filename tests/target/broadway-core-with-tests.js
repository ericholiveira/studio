...
describe("An actor", function () {
  ...
  it("should receive a message", function (done) {
    sender.send(RECEIVER_UNDEF_ID, 'hello').then(done);
  });
...
},{"../../target/core/broadway":6}],12:[function(require,module,exports){
Broadway = require('../../target/core/broadway');
...
},{"../../target/core/broadway":6}],13:[function(require,module,exports){
Broadway = require('../../target/core/broadway');
...
},{"../../target/core/broadway":6}],14:[function(require,module,exports){
Broadway = require('../../target/core/broadway');
Q = require('q');
...
},{"../../target/core/broadway":6,"q":4}]},{},[11,12,13,14]);
